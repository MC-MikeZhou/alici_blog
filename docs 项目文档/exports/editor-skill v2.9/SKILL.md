...
required-docs:
  - path: "/.claude/skills/_shared/BRAND_VISUAL_GUIDE.md"
    purpose: "ICSB Brand Layer - green color palette and visual identity"
  - path: "/.claude/skills/_shared/PRODUCT_CATALOG.md"
    purpose: "CTA URL mapping and product specifications"
  - path: "/.claude/skills/_shared/BLOG_CONTENT_REGISTRY.md"
    purpose: "Content index for internal linking - Pillar/Cluster architecture"
  - path: "/.claude/skills/_shared/editor/prompts/title-formulas.yaml"
    purpose: "37 title formula patterns for competitive validation"
  - path: "/.claude/skills/_shared/editor/prompts/opening-patterns.yaml"
    purpose: "24 AEO opening patterns for competitive validation"
  - path: "/.claude/skills/_shared/editor/prompts/integration-levels.yaml"
    purpose: "L1-L20 product integration levels"
  - path: "/.claude/skills/_shared/editor/prompts/citation-pyramid.yaml"
    purpose: "5-level citation authority pyramid"
  - path: "/.claude/skills/_shared/editor/prompts/link-parameter-rules.yaml"
...
```bash
Read /.claude/skills/_shared/BRAND_VISUAL_GUIDE.md
Read /.claude/skills/_shared/PRODUCT_CATALOG.md
```
...
**CRITICAL**: All prompts MUST include the Brand Layer from `/.claude/skills/_shared/BRAND_VISUAL_GUIDE.md`
...
**Read before generating any image**: `/.claude/skills/_shared/BRAND_VISUAL_GUIDE.md`
...
> **Reference**: `/.claude/skills/_shared/editor/prompts/opening-patterns.yaml`
...
> **References**:
> - `/.claude/skills/_shared/editor/prompts/title-formulas.yaml`
> - `/.claude/skills/_shared/editor/prompts/integration-levels.yaml`
...
> **Reference**: `/.claude/skills/_shared/editor/prompts/citation-pyramid.yaml`
...
**Step 1: 读取 Registry**
```bash
Read /.claude/skills/_shared/BLOG_CONTENT_REGISTRY.md
```
- 解析 Pillar Pages 表
